...
import kr.baby.controller.MakeAlbumController;
import kr.baby.controller.MakeDiaryController;
...
import kr.baby.controller.NewsWriteController;
import kr.baby.controller.NewsWriteFormController;
...
import kr.baby.controller.ShopOrderFinishController;
...
import kr.baby.controller.UpdateProfController;
	...
	public HandlerMapping() {
		...
		mappings.put("/makeDiary.do",new MakeDiaryController());
		mappings.put("/makeAlbum.do",new MakeAlbumController());
		...
		mappings.put("/newswriteform.do", new NewsWriteFormController());
		mappings.put("/newswrite.do",new NewsWriteController());
		...
		mappings.put("/shopOrderFinish.do", new ShopOrderFinishController());
