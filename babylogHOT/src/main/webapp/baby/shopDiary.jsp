				...
				<div class="shop_wrap">
					...
					<div class="prodcut_wrap">
						<div class="p_left">
							...
							<div class="p_img">
								<div>
									<img src="${cpath }/img/diary_1.jpg" alt="">
								</div>
								<div>
									<img src="${cpath }/img/diary_2.jpg" alt="">
								</div>
								<div>
									<img src="${cpath }/img/diary_3.jpg" alt="">
								</div>
							</div>
						...
						<div class="p_right">
							...
							<div class="order">
								<button type="button"
									onclick="location.href='${cpath}/makeDiary.do'">
								...
								<div class="d_text">
									<ul>
										<li><strong><i
											...
											<p>
												저희 쑥쑥은 고객님께 최대한 빠른 배송을 제공해드리기 위해 오후 네시 이전에 주문하시면 당일 배송을 원칙으로
